...
class ScientificCircleBudget(SQLModel, table=True):
    __tablename__ = "scientific_circle_budget"

    scientific_circle_budget_id: Optional[int] = Field(default=None, primary_key=True)
    scientific_circle_name: str
    total_budget: float
    spent_money: float
    ...
    purchase_requests: list["PurchaseRequest"] = Relationship(back_populates="scientific_circle_budget")
    public_purchase_plan_list: Optional["PublicPurchasePlanList"] = Relationship(back_populates="scientific_circle_budget")
    fundings: list["Funding"] = Relationship(back_populates="scientific_circle_budget")
...
class PurchaseRequest(SQLModel, table=True):
    ...
    scientific_circle_budget_id: int = Field(foreign_key="scientific_circle_budget.scientific_circle_budget_id")
    gslbccf_id: Optional[int] = Field(default=None, foreign_key="grouped_shops_list_by_cpv_category_and_funding.gslbccf_id")

    scientific_circle_budget: Optional["ScientificCircleBudget"] = Relationship(back_populates="purchase_requests")
...
class PublicPurchasePlanList(SQLModel, table=True):
    ...
    scientific_circle_budget: Optional["ScientificCircleBudget"] = Relationship(back_populates="public_purchase_plan_list")
...
class Funding(SQLModel, table=True):
    ...
    scientific_circle_budget: Optional["ScientificCircleBudget"] = Relationship(back_populates="fundings")
    project: Optional["Project"] = Relationship(back_populates="fundings")
    shop_purchase_lists: Optional["ShopPurchaseList"] = Relationship(back_populates="funding")
...
class Item(SQLModel, table=True):
    ...
    shop_purchase_list: Optional["ShopPurchaseList"] = Relationship(back_populates="items")
...
class ShopPurchaseList(SQLModel, table=True):
    ...
    items: list["Item"] = Relationship(back_populates="shop_purchase_list")
