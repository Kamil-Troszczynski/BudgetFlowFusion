...
-- 4. Skarbnicy (Project Finance Managers)
...
-- 5. Studenci (Dodano association_id na samym końcu)
...
-- 8. Grupy Sklepów po CPV
INSERT INTO grouped_shops_list_by_cpv_category_and_funding (allocated_money) VALUES
(20000.00),
(10000.00),
(5000.00);

-- 9. Kategorie Produktów (UWAGA: Zmieniono cpv_id na poprawne kody CPV typu String)
-- Jeśli w Twoim pliku relations.py to pole nazywa się inaczej (np. cpv_code), podmień słowo "cpv" poniżej
...
-- 14. Elementy na Listach Zakupowych
...
-- 15. Wnioski o Zakup (Purchase Requests)
...
-- Przypięcie wniosków do Skarbników
...
-- Finalne update'y konfiguracyjne
